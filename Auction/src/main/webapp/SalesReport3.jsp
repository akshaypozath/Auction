...
%>
  ...
  <body>
    ...
    <%
		...
		ResultSet RS3 = getEarnRptForAuction(3);
    ...
    <div class="content-wrapper">
      ...
      <p class="sub-title">Earning group by Sub Category, Product and Sellers</p>
      	<table border="1">
			<tr>
				<th>Sub Category</th>
				<th>Product</th>
 		 	...
 		 	while(RS3.next()){ %>
           	<TR>
    			<TD> <%= RS3.getString("scname") %></td>
                <TD> <%= RS3.getString("pname") %></TD>
                <TD> <%= RS3.getString("seller") %></TD>
                <TD> <%= RS3.getFloat("total_earnings") %></TD>
            </TR>
            <% } %>
      </table>
    </div>
