...
%>
  ...
  <body>
    ...
    <%
		...
		ResultSet RS2 = getEarnRptForAuction(2);
    ...
    <div class="content-wrapper">
      ...
      <p class="sub-title">Best Selling Item</p>
      	<table border="1">
			<tr>
				<th>Best Selling Item Based Top Earning</th>
 		 	...
 		 	while(RS2.next()){ %>
           	<TR>
    			<TD> <%=RS2.getString("best_selling_item") %></td>
            </TR>
            <% } %>
      </table>
