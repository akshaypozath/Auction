...
%>
  ...
  <body>
    ...
    <%
		...
		ResultSet RS0 = getEarnRptForAuction(0);
    ...
    <div class="content-wrapper">
      ...
      <p class="sub-title">Earning Reports for all Auction</p>
      	<table border="1">
			<tr>
				<th>Seller ID</th>
				<th>Sub Category</th>
 		 	...
 		 	while(RS0.next()){ %>
           	<TR>
    			...
    			<TD> <%= RS0.getString("scname") %></TD>
                <TD> <%= RS0.getString("pname") %></TD>
                <TD> <%= RS0.getTimestamp("listdate") %></TD>
                <TD> <%= RS0.getTimestamp("expdate") %></TD>
                <TD> <%= RS0.getFloat("startprice") %></TD>
                <TD> <%= RS0.getString("bid_status") %></TD>
                <TD> <%= RS0.getFloat("earn") %></TD>
                <TD> <%= RS0.getString("buyer") %></TD>
            </TR>
            <% } %>
      </table>
    </div>
